        ...
        return (
            <CompStyle>
              ...
              <ListStyle>
                ...
                <ItemStyle style={{backgroundColor: bgColor2}}onClick={this.but2}>Lecture</ItemStyle>
                <ItemStyle style={{backgroundColor: bgColor1}}onClick={this.but1}>Study Break</ItemStyle>
